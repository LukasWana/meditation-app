...
const CacheManagementPanel = () => {
    ...
    if (!cacheData.audio_metadata) {
      return (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <Heading level={3} className="font-semibold text-yellow-800">⚠️ Cache není vytvořen</Heading>
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          <Heading level={3} className="font-semibold text-blue-800">📊 Celkové statistiky cache</Heading>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4">
            <Heading level={3} className="font-semibold text-green-800">🎵 Hudba ({hudbaFiles.length} souborů)</Heading>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <Heading level={3} className="font-semibold text-purple-800">💬 Meditacie ({meditacieFiles.length} souborů)</Heading>
            <div className="space-y-2">
              <div className="text-sm">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <Heading level={3} className="font-semibold text-gray-800">🕒 Nejnovější soubory</Heading>
  ...
  return (
    <div className="max-w-7xl mx-auto p-6">
      <div className="mb-6">
        <Heading level={1} visual={1} className="font-bold text-gray-900">🗄️ Cache Management</Heading>
      ...
      {(cacheError || error) && (
        <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
          <Heading level={3} className="font-semibold text-red-800">❌ Chyba</Heading>
      ...
      {!user && !loading && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
          <Heading level={3} className="font-semibold text-yellow-800">🔐 Vyžaduje přihlášení</Heading>
          <p className="text-yellow-700">
      ...
      {scanningFiles && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
          <Heading level={3} className="font-semibold text-blue-800">⏱️ Extracting Audio Metadata</Heading>
