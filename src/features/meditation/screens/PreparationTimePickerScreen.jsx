...
const PreparationTimePickerScreen = ({
  onNavigateToScreen,
  onTouchStart,
  onTouchMove,
  onTouchEnd,
  ...
  const { preparationTime, setPreparationTime } = useBreathStore();
  const [tempValue, setTempValue] = useState(preparationTime || 0);
...
export default PreparationTimePickerScreen;
